...
<body>
    ...
    <header>
        <div class="container-fluid">
            ...
            <center><img src="img/img-reportes.jpg" alt="portada" class="img-responsive"></center>
        </div>
    </header>
    ...
    <nav>
        ...
        <ul class="nav nav-pills nav-justified">
          ...
          <li role="presentation" class="active"><a href="/planeacion/reportes"><span class="glyphicon glyphicon-file"></span> Reportes</a></li>
        </ul>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 filaCompleta">
                    <p>Realice los filtros correspondientes para generar su reporte.</p>
