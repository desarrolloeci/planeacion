...
<%response.setHeader("Cache-Control", "no-cache");
        ...
        planes    = bd.Planes();
        proyectos = bd.ConsultaALLProyectosUser(ccemp);
%>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav>
        ...
        <ul class="nav nav-pills nav-justified">
          ...
          <li role="presentation" class="active"><a href="/planeacion/historial"><span class="glyphicon glyphicon-list-alt"></span> Historial</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 filaCompleta">
                    <h3>A continuación se presenta su historial de <strong>Proyectos en el Sistema </strong></h3><br>
