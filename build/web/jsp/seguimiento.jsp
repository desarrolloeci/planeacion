        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 filaCompleta">
                    <h3>A continuación se presentan <strong>los proyectos bajo su responsabilidad con seguimiento  a la fecha:</strong></h3><br>
                ...
                <div class="col-md-12 filaCompleta">
                    <h3>Proyectos en ejecución y en los que usted es <strong>responsable de alguna actividad y requiere seguimiento a la fecha:</strong></h3><br>
                    <p>
                    Para ordenar, clic sobre el titulo de la columna. <img src="img/order.png" alt="Smiley face" height="30" width="30">.
