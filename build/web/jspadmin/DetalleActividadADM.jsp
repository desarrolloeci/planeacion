...
<%response.setHeader("Cache-Control", "no-cache");
        ...
        String Valor="", Cadena="", Valor1="", Cadena1="";
...
<!--CONTENIDOS-->
    <section>
        <div class="container">
                            ...
                            <center>
                                ...
                                <br>
                                  ...
                                  <div class="row" style="display: block;">
                                      ...
                                      <br>
                                   <center><input class="btn btn-info" type="button" value="< Regresar al Proyecto" name="volver atrás2" onclick="window.history.back()" /></center><br>
                                      <br>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <br>
                                                                   <td>                                                              
                                                                       ...
                                                                       <input type="hidden" name="tipusr" value="A">
            ...
            </div>                                 <center><input class="btn btn-info" type="button" value="< Regresar al Proyecto" name="volver atrás2" onclick="window.history.back()" /></center><br>
