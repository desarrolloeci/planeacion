...
<input class="btn btn-danger" type="button" value="Ver MegaProyecto" name="volver atrás2" onclick="location.href='/planeacion/detalleproyadm?idp=<%=bd.ConsultaSiPerteneceAMegapro(idp)%>#collapseThree'" /><br><br><%}%>
                   ...
                   <center><h3>Acciones del Administrador</h3></center>
                    ...
                    <div class="colorFormulario">                        
                                ...
                                <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                                    ...
                                    <h5><strong>Asociar Presupuesto de Erogación oficial</strong></h5><br>
                                ...
                                <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
                                        ...
                                        <br>    <center>
                                                ...
                                                <input class="btn btn-warning" type="submit" value="DEVOLVER A PLANEACIÓN" name="btnest">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-xs-12 col-md-4">
                                         <form action="CambiarEstadoPRAdm" method="POST" onsubmit="return confirm('Confirma el cambio de estado del Proyecto?');">
                                             ...
                                             <div class="submit">
                                                 <center><input class="btn btn-primary btn-lg" type="submit" value="Iniciar Ejecución del Proyecto"/></center>
                                             </div>
                                         </form>
                                     </div>
                                     <div class="col-xs-12 col-md-4"></div>                              
