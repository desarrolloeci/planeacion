...
<%response.setHeader("Cache-Control", "no-cache");
        ...
        planes    = bd.Planes();
        proyectos = bd.ConsultarTotalProyectos();
%>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav>
        ...
        <ul class="nav nav-pills nav-justified">
          ...
          <li role="presentation" class="active"><a href="/planeacion/allproyectos"><span class="glyphicon glyphicon-lamp"></span> Todos los Proyectos</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12 filaCompleta">
                   ...
                   <script language="javascript">
                    ...
                    <h3>A continuación se presentan <strong>todos los proyectos</strong> de la plataforma. </h3> Total consultados: <%=proyectos.size()%><br><br>
                    <p>
