            ...
            <div class="row">
                ...
                <div class="col-sm-5 col-md-5">
                    <div class="formulario">
                        <form class="form-horizontal" name="login" method="POST" action="/planeacion/Login" onsubmit="return validation()">
                      <div class="form-group">
                        <label class="col-sm-9 col-md-5 control-label">Usuario:   </label>
                        <div class="col-sm-12 col-md-7">
                            <input type="text" readonly="true" class="form-control" value="${userInfo.displayableId}" placeholder="Usuario" name="usr">
                        </div>
                      </div>
                      <div class="form-group">
