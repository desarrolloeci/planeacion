...
<%response.setHeader("Cache-Control", "no-cache");
        ...
        archivosobs    = bd.Consultafilesobs(idp);
        ...
        if(Integer.parseInt(datosb.elementAt(1).toString())>=5){
            
            response.sendRedirect("verproyecto?idp="+idp);
        }
        
        String Valor="", Cadena="", ValorDed="", ValorEro="", finf = "";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 franjaColor">
                    <center><h4>.:: Plataforma de seguimiento a la planeación ::.</h4><div align="right">
                            <form action="salir">
        ...
        <div class="container">
            ...
            <div class="colorFormulario">
                ...
                <center>
                    ...
                    <br>
                    <marquee SCROLLDELAY=40 WIDTH=30% ><font color="orange">Proyecto en Planeación</font></marquee>
                    <br><br>
...
<%if(!bd.ConsultaSiPerteneceAMegapro(idp).equals("0") && bd.ValidarDirectorResponMegapro(ccemp).equals("1")){%><input class="btn btn-danger" type="button" value="Ver MegaProyecto" name="volver atrás2" onclick="location.href='/planeacion/detalleproy?idp=<%=bd.ConsultaSiPerteneceAMegapro(idp)%>#collapseThree'" /><br><br><%}%>

<% if((ccemp.equals(datosb.elementAt(17).toString()) || ccemp.equals(datosb.elementAt(6).toString()) || ccemp.equals(datosb.elementAt(7).toString())) && (datosb.elementAt(1).equals("1") || datosb.elementAt(1).equals("3")) || bd.ValidarDirectorResponMegapro(ccemp).equals("1")){%>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                        ...
                        <div class="panel-body">
                            ...
                            <%if(datosb.elementAt(3).toString().equals("2")||datosb.elementAt(3).toString().equals("4")||datosb.elementAt(3).toString().equals("5")){%> 
									...
									<select name="finesauto" id="finesauto" class="form-control" onChange="recargarS2(this.value)" required>
                                                                            <%if (fines.size() > 0){
                                                                                   ...
                                                                                   <%} Cadena="Seleccione un elemento de la lista"; Valor="";
                                                                                    ...
                                                                                    %>
                                                                                    <option value="<%=Valor%>" selected='selected'><%=Cadena%></option><%Valor="";Cadena="";%>
                                                                                     <input type="hidden" value="<%=Valor%>" name="numerosig" >
                                                                                    <%
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                      ...
                      <div class="panel-body">
                               ...
                               <!--   <th>Detalle</th>  -->
                                    ...
                                    %>
                                    <tr>
                                        <td><form id="formulario" method="POST" action="ConsecutivoActividades">
                                                <input type="text" value="<%=(m+1)%>" name="ConsecAct" class="col-xs-12 col-md-3 col-lg-3" style="text-align:center;" onblur="this.form.submit();">
                                                <input type="hidden" value="<%=aux.elementAt(0)%>" name="idact">
                                                <input type="hidden" value="<%=idp%>" name="idp">
                                            </form>
                                        </td>
                                 ...
                                 <!-- <td><a onClick="if (window.open) { window.open('/planeacion/DetalleActividad?idp=<%=idp%>&act=<%=aux.elementAt(0)%>', return false; }" href="DetalleActividad?idp=<%=idp%>&act=<%=aux.elementAt(0)%>"<%=aux.elementAt(0)%>><img src="img/detallevin.png" width="20" height="22" border="0" ></a></td> -->
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><button class="btn btn-success" onclick="location.href='/planeacion/DetalleActividad?idp=<%=idp%>&act=<%=aux.elementAt(0)%>'">(Ver/Editar) Detalle Actividad <%=(m+1)%></button></h5></td>        
                                    </tr>
                                    <%}%>
                      ...
                      <div class="panel-body">
                               ...
                               <div class="colorFormulario">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><button class="btn btn-success" onclick="location.href='/planeacion/detalleproy?idp=<%=aux.elementAt(0)%>'">Ver Proyecto Asociado</button></h5></td>        
                                    </tr>
                                    <%}%>
               ...
               <div class="colorFormulario">                                                                      
                   <div class="row">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <form action="CambiarEstadoPR" method="POST" onsubmit="return confirm('Confirma el cambio de estado del Proyecto?');">
                                    <input type="hidden" name="idp" value="<%=idp%>">
                                    <input type="hidden" name="estado" value="2">
                                <div class="submit">
                                    <center><input class="btn btn-primary btn-lg" type="submit" value="Enviar proyecto a la Oficina de Desarrollo Institucional (ODI)"/></center>
                                </div>
                                </form>
                            </div>
                            <div class="col-xs-12 col-md-4"></div>                              
                                    ...
                                    <textarea name="observadmin" class="form-control" placeholder="Observaciones del Administrador" maxlength="7999" rows="8" required><%=datosb.elementAt(19).toString()%></textarea>
                                      ...
                                      <%if(archivosobs.size() > 0){%>
                                      <br>En la sección encontrará los documentos que ha adjuntado el administrador con algunas recomendaciones a la formulación del proyecto.<br>
                                        <div class="panel-body">
                                        <div class="colorFormulario"> 
                                      <label>Archivos</label>
                                      <div class="row">
                                          <table class="table">
                                              ...
                                              <% for ( int m = 0 ; m < archivosobs.size() ; m++ ){
                                                                  auxin = (Vector)archivosobs.elementAt(m);
                                                                  numero_archivo = m+2;
                                              %>
                                              <tr>
                                                  <td><%=(m+1)%></td>
                                      ...
                                      <%}else{%>
                                        <br>No hay archivos adjuntos por el administrador.<br>
                                      <%}%>
