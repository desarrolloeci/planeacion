...
<%      
        ...
        cargos      = bd.cargoseci();
        param  = bd.parametros("4");
        }
        String vigencia = bd.vigenciaproy(idp);
        
        BigInteger TotalRubros;
        
        String[] fecha = datosb.elementAt(1).toString().split("/");
...
<!--CONTENIDOS-->
    <section>
        <div class="container">
                            ...
                            <center>
                                ...
                                <form action="ActualizaActividad" method="POST">
                                    ...
                                    <tr><input type="hidden" name="act" value="<%=act%>"><input type="hidden" name="idp" value="<%=idp%>">
                                        <td >Nombre Actividad:</td><td colspan="3"><input class="form-control" value="<%=actividad.elementAt(1)%>" type="text" name="nom" pattern="[A-Za-z0-9ñÑáéíóú+-_ ]{0,999}" required></td></tr> 
                                        <tr><td>Fecha Inicio: </td><td><input class="form-control" value="<%=actividad.elementAt(3)%>" type="text" name="feciniac" id="datepicker" required></td>       
                                            <td>Fecha Fin:    </td><td><input class="form-control" value="<%=actividad.elementAt(4)%>" type="text" name="fecfinac" id="datepicker2" required></td></tr>        
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Descripción:</td><td colspan="3"><textarea rows="6" cols="20" class="form-control" name="desc" pattern="[A-Za-z0-9_-ñáéióúcC. ]{0-9}" required><%=actividad.elementAt(2)%></textarea></td>
                                        </tr>
                                </table>
                                <br>
                                <input class="btn-lg" type="submit" name="Guardar" value="Guardar Cambios">
                                  ...
                                  <div class="row" style="display: block;">
                                      ...
                                      <br>
                                   <center><input class="btn btn-info" type="button" value="< Regresar al Proyecto" name="volver atrás2" onclick="location.href='/planeacion/detalleproy?idp=<%=idp%>#collapseThree'" /></center><br>
                                      <br>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td>
                                                                      <form action="EliminaInfoActTipo" method="POST" onsubmit="return confirm('Esta Seguro de eliminar el Registro?');">
                                                                                ...
                                                                                <input type="hidden" name="usuario" value="DetalleActividad">
                                                                                ...
                                                                                <form action="NuevaDedPersonal" method="POST">
                                                                                    ...
                                                                                    <div class="col-xs-12 col-md-3 col-lg-10">
                                                                                            <div class="form-group espaciado">
                                                                                                    ...
                                                                                                    <input class="form-control" type="number" min="1" name="horaspart" required>
                                                                                                    <%}%>
                                                                                            </div>
                                                                                    </div>
                                                                                   ...
                                                                                   <div class="Box2" style="display:none">
                                                                                    ...
                                                                                    <div class="col-xs-12 col-md-3 col-lg-4">
                                                                                            <div class="form-group espacio">
                                                                                                <input type="hidden" value="<%=idp%>" name="idp">
                                                                                                <input type="hidden" value="<%=act%>" name="idact">
                                                                                                 <input type="hidden" value="usrn" name="idadm">
                                                                                                <input type="submit" value="Agregar Participante" class="btn-lg">                                
                                                                                            </div>
                                                                                    </div>
                                                                                    </form>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <br>
                                                                  <td>                                                              
                                                                       ...
                                                                       <input type="hidden" name="idp" value="<%=idp%>">
                                                                       <input type="hidden" name="act" value="<%=act%>">
                                                                       <input type="hidden" name="tipusr" value="U">
                                                                                               ...
                                                                                               <div class="col-md-offset-1 col-md-3">
                                                                                                  <div class="form-group"> <input type="hidden" value="<%=idp%>" name="idp">
                                                                                                      ...
                                                                                                      <select name="rubro"  class="form-control" required>
                                                                                                          <%if (rubro.size() > 0){ 
                                                                                                          %><option value="" selected='selected'>Seleccione el Rubro</option><%
                                                                                                                  for (int ii = 0; ii < rubro.size(); ii++) {
                                                                                                                          Vector infusu = (Vector)rubro.elementAt(ii) ;
            ...
            </div>                                 <center><input class="btn btn-info" type="button" value="< Regresar al Proyecto" name="volver atrás2" onclick="location.href='/planeacion/detalleproy?idp=<%=idp%>#collapseThree'" /></center><br>
